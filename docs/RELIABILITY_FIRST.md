...
[FEATURE_QUALIFICATION.md](FEATURE_QUALIFICATION.md). Version 1.0.15 includes
...
Barline 1.0.15 was qualified on separate Apple Silicon macOS 26.6.2 and macOS
