...
test('current production source requires exact configuration and preserves source', async () => {
  ...
  const release = {
    ...
    downloadURL: 'https://github.com/Mabry-Ventures/mv-barline/releases/download/v1.0.13/Barline-1.0.13.dmg',
    sourceURL: 'https://github.com/Mabry-Ventures/mv-barline/releases/download/v1.0.13/Barline-1.0.13-source.tar.gz',
    checksumsURL: 'https://github.com/Mabry-Ventures/mv-barline/releases/download/v1.0.13/SHA256SUMS',
    releaseURL: 'https://github.com/Mabry-Ventures/mv-barline/releases/tag/v1.0.13',
    contributionURL: 'https://buy.stripe.com/cNibJ1a370l33AVgnk1ck02',
  };
  try {
    ...
    assert.match(await readFile(join(outputDirectory, 'index.html'), 'utf8'), /Download Barline 1\.0\.13/);
